 ...
 *
 * @category Controller
 * @package  modules.gallety.controllers
 * @author   Team <k.ilushin@gmail.ru>
 * @license  BSD http://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_BSD
 *
 **/
class GalleryBackendController extends \components\controllers\BackController
{
    ...
    public function actions()
    {
        return [
            'inline' => [
                'class' => '\components\actions\YInLineEditAction',
                'model' => 'Gallery',
                'validAttributes' => ['name', 'description', 'status']
            ],
            'sortable' => [
                'class' => '\components\actions\SortAction',
        ...
        if (($data = Yii::app()->getRequest()->getPost('Gallery')) !== null) {
            ...
            if ($model->save()) {
                ...
                Yii::app()->getUser()->setFlash(
                    \widgets\YFlashMessages::SUCCESS_MESSAGE,
    ...
    private function _addImage(Image $image, array $imageData, Gallery $gallery)
    {
        try {
            ...
            Yii::app()->getUser()->setFlash(
                \widgets\YFlashMessages::ERROR_MESSAGE,
                $e->getMessage()
            );
        }
    }
    ...
    public function actionDeleteImage($id = null, $method = null)
    {
        ...
        Yii::app()->getUser()->setFlash(
            $result ? \widgets\YFlashMessages::SUCCESS_MESSAGE : \widgets\YFlashMessages::ERROR_MESSAGE,
            $message
        );
