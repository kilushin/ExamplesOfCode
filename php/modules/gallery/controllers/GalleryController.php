 ...
 *
 * @category CMSController
 * @package  CMS.modules.gallety.controllers
 * @author   <k.ilushin@gmail.ru>
 * @license  BSD http://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_BSD
 * @link     http://CMS.ru
 *
 **/
class GalleryController extends \CMS\components\controllers\FrontController
{
    /**
     *
     */
            ...
            try {
                ...
                if ($image->save() && $gallery->addImage($image)) {
                    ...
                    Yii::app()->user->setFlash(
                        CMS\widgets\YFlashMessages::SUCCESS_MESSAGE,
                ...
                Yii::app()->user->setFlash(
                    CMS\widgets\YFlashMessages::ERROR_MESSAGE,
                    $e->getMessage()
                );
            }
        }
    ...
    public function actionDeleteImage($id = null)
    {
        ...
        Yii::app()->user->setFlash(
            $result ? CMS\widgets\YFlashMessages::SUCCESS_MESSAGE : CMS\widgets\YFlashMessages::ERROR_MESSAGE,
            $message
        );
