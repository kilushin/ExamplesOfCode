...
class CouponBackendController extends application\components\controllers\BackController
{
    public function actions()
    {
        return [
            'inline' => [
                'class' => 'application\components\actions\YInLineEditAction',
                'model' => 'Coupon',
                'validAttributes' => [
                    'status',
                ],
        ...
        if ($attributes) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash(
                    application\widgets\YFlashMessages::SUCCESS_MESSAGE,
