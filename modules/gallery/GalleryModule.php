 ...
 */
class GalleryModule extends CMS\components\WebModule
{
    /**
     *
     */
    ...
    {
        return Yii::t('GalleryModule.gallery', 'k.ilushin');
    }
    ...
    {
        return Yii::t('GalleryModule.gallery', 'k.ilushin@gmail.com');
    }
    /**
     * @return string
     */
    ...
    {
        return [
            'editor' => Yii::app()->getModule('CMS')->editors,
